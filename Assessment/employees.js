...
const Employee1 = new Employee("Mary Anne", "5pm")
...
const empOne = new Employee("Jess", "Weekdays mornings")
...
class Manager extends Employee {
    ...
    getEmployees() {
        console.log(`${this.name} manage ${this.employees}`)
    }
...
let managerInfo = new Manager("Eric", "3pm", "Martha",)

managerInfo.addEmployee("Mark")

managerInfo.getEmployees()
...
let managerTwo = new Manager("Winston", "Weekdays morning, weekdays afternoon", "Cece and Schmidt")
