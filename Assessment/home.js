...
let greetUser = name => console.log(`Welcome back ${name}`)
...
let canWeDeliverTwo = (value) => {
    ...
    return "Sorry, we can't deliver to that zip code";
};

console.log(canWeDeliverTwo(852051))
...
const changeValue = deals.findIndex((str) => str.desc = 1)
deals[changeValue] = {
    title: "10% Off",
    desc: 'Applied to your entire order when you spend $30 or more',
}
...
const newStr = '   This deal lasts until the end of April! '.replace(/\s+/g, ' ').trim()
