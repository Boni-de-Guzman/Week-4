...
//arrow function
const evenNumbers1 = mixedNumbers.filter(num => num % 2 === 0)
...
const postTaxPrices1 = prices.map(num => num * 1 + 0.07)


console.log(postTaxPrices)
console.log(postTaxPrices1)
...
// CODE HERE
const totalPopulations = populations.reduce(function (num1, num2) {
  return num1 + num2
})

//arrow function

const totalPopulation1 = populations.reduce((num1, num2) => num1 + num2)
...
const myStrongest1 = monstersInYourPocket.filter(num => num.CP > 200)

console.log(myStrongest)
console.log(myStrongest1)
...
const totalOrders = orders.map(function (num) {
  return num.price + (num.price * num.tax)
})


const totalOrders1 = orders.map(num => num.price + (num.price * num.price))
